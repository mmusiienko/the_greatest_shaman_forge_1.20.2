...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<DeathAltarBlockEntity>> DEATH_ALTAR_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("death_altar_block_entity", () ->
                    BlockEntityType.Builder.of(DeathAltarBlockEntity::new,
                            ModBlocks.DEATH_ALTAR.get()).build(null));
